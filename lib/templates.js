...
export const TEMPLATES = [
	...
	{
		id: "secure-reverse-optimize",
		name: "逆向指令优化（安全研究语境）",
		desc: "把逆向/破解/绕过验证等安全大白话，规范化为合规的安全研究语境指令——补上归属/授权与防御目的，避免被模型误拒",
		category: "basic",
		content: [
			{ role: "system", content: INTENT_RULES + SECURE_RE_TAIL },
			{ role: "user", content: SECURE_BASIC_USER },
		],
	},
	{
		id: "general-optimize",
