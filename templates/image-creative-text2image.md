{"id":"image-creative-text2image","name":"解构/创造性提示词","desc":"创意向优化：强化想象力与艺术风格表达，适合插画与概念图","category":"image","order":130}
...
2. 禁止事项
   ...
   - **以上"避免"清单只约束你自己新增的修饰**：用户草稿里已有的主体、风格、元素、词汇（哪怕命中上面的禁用词，例如用户明确要"星空"）一律保留——保真优先于本模板的风格偏好
3. 边界处理
